public class Array {
    public static void main(String[] args){
        //Matriz unidimensional, Vetor ou Array

        //Forma crua de declaração
        ...
        String[] nome = {"Matheus", "Silva", "Hevelyn", "Helena", "Maria"};
        ...
        System.out.println(desafio[0][1]);
        System.out.println(desafio[1][0]);
